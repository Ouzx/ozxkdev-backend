    ...
    <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
      <div className="md:flex">
        <div className="flex justify-center md:justify-start">
          <img
            className="w-full h-48 md:h-48 md:w-48 object-cover rounded-lg"
            alt="post"
        ...
        <div className="p-8">
          <div className="tracking-wide text-[21px] text-black font-semibold">
            Post Title
          </div>
          ...
          >
            <p className="mt-4 text-lg leading-tight font-medium text-gray-500 hover:underline">
              Edit Post {`>`}{" "}
            </p>
          </button>
        </div>
